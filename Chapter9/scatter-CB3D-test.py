...
correct_input = False
pp = PdfPages(PATH + "/figures-scatter-CB3D-test.pdf")
...
def celestial_movement3D():
	...
	bodies_list = [Celestial_body(0, 0, 0, 0, 0, 0, 0, 2e30, 69551e4),
                Celestial_body(1, 698169e5, 0, 0, 47.4e3,
                               7.005, 90, 3.285e23, 2439.7e3),
                Celestial_body(2, 108939e6, 0, 0, 35.02e3,
                               3.39458, 90, 4.8675e24, 6051.8e3),
                Celestial_body(3, 1521e8, 0, 0, 29.78e3, 7.155,
                               90, 5.97237e24, 6371.0e3),
